...
export function DeleteGenreModal({
  isOpen,
  onClose,
  onConfirm,
  genreTitle,
                ...
                >
                  ...
                  <div className="mb-8">
                    <p className="text-light-text2 dark:text-dark-text2">
                      Você tem certeza que deseja excluir o gênero{" "}
                      <strong>{genreTitle}</strong>?
                    </p>
                    <p className="text-light-text3 dark:text-dark-text3 mt-2">
                      Esta ação não poderá ser desfeita e afetará todos os
                      filmes associados a este gênero.
                    </p>
                  </div>
